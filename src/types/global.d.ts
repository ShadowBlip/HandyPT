  ...
  interface Window {
    ...
    SteamClient: {
      Apps: {
        ...
        SetShortcutStartDir: (id: number, dir: string) => Promise<void>;
        // await SteamClient.Apps.SetShortcutLaunchOptions(2492847199, "flatpak foo");
        SetShortcutLaunchOptions: (id: number, args: string) => Promise<void>;
